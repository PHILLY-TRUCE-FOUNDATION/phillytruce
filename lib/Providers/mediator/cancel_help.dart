...
class CancelUserRequest {
  ...
  Future<bool> cancelUserRequest(String help_id, context) async {
    ...
    bodyParameter['help_id'] = help_id.toString();
    // bodyParameter['user_id'] = userData.user_id.toString();

    final url = '$_baseUrl/mediator_cancel';
    var responseJson;
    try {
