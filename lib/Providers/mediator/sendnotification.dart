...
class SendNotification {
  ...
  Future<bool> sendNotification(String receiverId, message , helpId, context) async {
    ...
    bodyParameter['receiver_id'] = receiverId.toString();
    bodyParameter['message'] = message.toString();
    bodyParameter['help_id'] = helpId.toString();

    final url = '$_baseUrl/send_chat_message_notification';
    var responseJson;
    try {
    ...
    print('unefw' + responseJson.toString());
    return responseJson;
