...
class GetMediatorsLocationClient {
  final _baseUrl = '${AddMediatorApiClient.baseUrl}';
  http.Client httpClient = http.Client();

  Future<GetLocations> getLocations(helpId) async {
    ...
    print('Flutter Fully Truce' +
        ...
        '/' +
        userData.unique_token.toString());
    final url = '$_baseUrl/get_mediators_user_current_location';
    var responseJson;
    try {
      ...
      Fluttertoast.showToast(
          msg:
              'Some thing went Wrong . to get Mediator Location Please Try again later');
