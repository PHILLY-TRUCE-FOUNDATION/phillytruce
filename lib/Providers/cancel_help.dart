...
class CancelHelpRequestClient {
  final _baseUrl = '${AddMediatorApiClient.baseUrl}';
  http.Client httpClient = http.Client();

  Future<String> cancelHelpRequest(int helpId) async {
    ...
    final url = '$_baseUrl/cancel_help';
    ...
    try {
      ...
      Fluttertoast.showToast(
          msg:
          'Some thing went Wrong . to cancel Please Try again later');
